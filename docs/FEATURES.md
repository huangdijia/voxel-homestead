...
| M2-ECOLOGY-01 | M2 | 更多生物、农业、生长、繁殖、驯养和坐骑 | 部分已实现／待浏览器全面验收 | 当前为四类作物、猪羊及固定橡树生长子集，详见上表与 M2-NATURE-01；继续打通甜菜自然来源、其余植物、生物、驯养／坐骑及跨区块生命周期。 |
